        ...
        <div class="max-w-screen-xl px-4 pt-36 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:pt-36">
            ...
            <div class="bg-white shadow-md rounded-lg p-8 mx-auto w-full lg:w-full">
                    ...
                    <div class="flex justify-center items-center gap-2">
                        ...
                        <button
                            class="group relative w-full flex justify-center py-3 px-4 border border-transparent text-lg font-medium rounded-md text-white bg-[#FF0000] hover:bg-red-700 hover:text-white"
                        ...
                        <?php else :?>
                            ...
                            <button type="button" class="font-semibold items-center gap-2 bg-[#FF0000] text-white hover:bg-red-600 py-3 px-4 rounded-lg flex justify-center w-full text-center items-center" data-id="<?php echo $_GET['id']; ?>" onclick="deleteModal(this)">
            ...
            <div id="modalDelete" class="hidden fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
                <div class="bg-white p-8 rounded shadow-lg w-1/3">
                    ...
                    <div class="flex gap-4 items-center justify-center mt-4">
                        <button type="button" class="bg-[#FF0000] text-white py-2 px-4 rounded hover:bg-red-700 mr-4 w-1/3" onclick="closeModal()">Tidak</button>

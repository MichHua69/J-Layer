...
<body>
    ...
    <?php
        if(isset($_SESSION['error']['name'])) unset($_SESSION['error']['name']);
        if(isset($_SESSION['error']['email'])) unset($_SESSION['error']['email']);
        if(isset($_SESSION['error']['nik'])) unset($_SESSION['error']['nik']);
        if(isset($_SESSION['error']['telepon'])) unset($_SESSION['error']['telepon']);
        if(isset($_SESSION['error']['wilayah'])) unset($_SESSION['error']['wilayah']);
        if(isset($_SESSION['error']['noSurat'])) unset($_SESSION['error']['noSurat']);
        if(isset($_SESSION['error']['password'])) unset($_SESSION['error']['password']);
        if(isset($_SESSION['error']['password_confirmation'])) unset($_SESSION['error']['password_confirmation']);
        if(isset($_SESSION['error']['password_kepala'])) unset($_SESSION['error']['password_kepala']);
        if(isset($_SESSION['error']['password_confirmation_kepala'])) unset($_SESSION['error']['password_confirmation_kepala']);

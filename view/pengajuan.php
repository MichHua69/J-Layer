                            ...
                            <tr>
                                ...
                                <td class=" p-1 lg:px-4 lg:py-3 text-sm lg:text-lg">
                                    ...
                                    <?php elseif($item['id_status_validasi'] == 2 && $item['id_status_konfirmasi'] == 1) : ?>
                                        <button class="font-semibold items-center gap-2 bg-blue-500 text-white hover:bg-blue-600 py-3 px-4 rounded-lg flex justify-center w-full text-center items-center" onclick="window.location.href='<?= urlpath('detailvalidasi')?>?id=<?= $item['id'] ?>'">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 10" id="Information-Circle--Streamline-Micro" height="20" width="20"><desc>Information Circle Streamline Icon: https://streamlinehq.com</desc><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 9.5a4.5 4.5 0 1 0 0 -9 4.5 4.5 0 0 0 0 9Z" stroke-width="1"></path><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 7.5v-2" stroke-width="1"></path><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 3.53a0.25 0.25 0 0 1 0 -0.5" stroke-width="1"></path><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 3.53a0.25 0.25 0 0 0 0 -0.5" stroke-width="1"></path></svg>
                                            <span class="hidden lg:block">Detail Validasi</span>
                                        </button>
                                    <?php elseif ($item['id_status_validasi'] == 2 && $item['id_status_konfirmasi'] == 2): ?>
                                        <button class="font-semibold items-center gap-2 bg-green-500 text-white hover:bg-green-600 py-3 px-4 rounded-lg flex justify-center w-full text-center" onclick="window.location.href='<?= urlpath('detailkonfirmasi') . '?id=' . $item['id'] ?>'"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 10" id="Information-Circle--Streamline-Micro" height="20" width="20"><desc>Information Circle Streamline Icon: https://streamlinehq.com</desc><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 9.5a4.5 4.5 0 1 0 0 -9 4.5 4.5 0 0 0 0 9Z" stroke-width="1"></path><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 7.5v-2" stroke-width="1"></path><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 3.53a0.25 0.25 0 0 1 0 -0.5" stroke-width="1"></path><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 3.53a0.25 0.25 0 0 0 0 -0.5" stroke-width="1"></path></svg>
                                ...
                                <tr>
                                    ...
                                    <td class=" p-1 lg:px-4 lg:py-3 text-sm lg:text-lg">
                                        ...
                                        <?php if($item['pengajuan']['id_status_validasi'] == 2 && $item['pengajuan']['id_status_konfirmasi'] == 1):?>
                                            <button class="font-semibold items-center gap-2 bg-blue-500 text-white hover:bg-blue-600 py-3 px-4 rounded-lg flex justify-center w-full text-center items-center" onclick="window.location.href='<?= urlpath('detailvalidasi') ?>?id=<?= $item['pengajuan']['id'] ?>'">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 10" id="Information-Circle--Streamline-Micro" height="20" width="20"><desc>Information Circle Streamline Icon: https://streamlinehq.com</desc><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 9.5a4.5 4.5 0 1 0 0 -9 4.5 4.5 0 0 0 0 9Z" stroke-width="1"></path><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 7.5v-2" stroke-width="1"></path><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 3.53a0.25 0.25 0 0 1 0 -0.5" stroke-width="1"></path><path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" d="M5 3.53a0.25 0.25 0 0 0 0 -0.5" stroke-width="1"></path></svg>
                                                <span class="hidden lg:block">Detail Validasi</span>
                                            </button>
                        ...
                        <?php foreach ($pengajuan as $item): ?>
                            <tr>
                                ...
                                <?php if ($item['id_status_validasi'] == 1 && $item['id_status_konfirmasi'] == 1 ): ?>
                                    ...
                                    <!-- <button class="font-semibold items-center gap-2 bg-green-500 text-white hover:bg-green-600 py-3 px-4 rounded-lg flex justify-center w-full text-center" onclick="window.location.href='<?= urlpath('editpengajuan') . '?id=' . $item['id'] ?>'">
                                    ...
                                    <button class="font-semibold items-center gap-2 bg-red-500 text-white hover:bg-red-600 py-3 px-4 rounded-lg flex justify-center w-full text-center items-center" data-id="<?php echo $item['id']; ?>" onclick="deleteModal(this)">
